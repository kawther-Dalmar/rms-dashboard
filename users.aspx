    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
              ...
              <div class="col-sm-10">
                <asp:TextBox ID="txtusername" type="text" runat="server" class="form-control"   placeholder="User name"></asp:TextBox>
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-10">
      <asp:TextBox ID="txtpassword" type="password" runat="server" class="form-control" placeholder="Your Password"></asp:TextBox>
        ...
        <div class="form-group row">
         ...
         <div class="form-group row">
            ...
            <div class="col-sm-10">
      <asp:TextBox ID="txtphone" type="number" runat="server" class="form-control" placeholder="Your Number..."></asp:TextBox>
         ...
         <div class="form-group row">
            <div class="col-sm-10">
      <asp:TextBox ID="txtDor" type="date" runat="server" class="form-control" placeholder="Date Registrator..."></asp:TextBox>
        ...
        <div class="form-group row">
         ...
         <div class="col-sm-10">
        <asp:FileUpload ID="imgUpload" class="form-control" Text="Image Upload" runat="server" />
                     </div>
        </div>
        <div class="form-group row">
            <div class="col-sm-10"">
        ...
        <div class="col-md-10">
            ...
            <asp:GridView ID="dgvUsers" Width="100%" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical">
