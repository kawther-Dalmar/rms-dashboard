<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Changing Password.aspx.vb" Inherits="Changing_Password" %>
...
<head>
    ...
    <title>restaurant MS</title>
     <script src="Valiadation.js"></script>
</head>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <%-- =====================change pasword===================--%>
                 <div class="container">
                    ...
                    <form class="mt32" action="#" runat="server">
                     <h1 class="mt32 mb32">Changing <span></span> Password</h1>
                    ...
                    <div class="col-sm-10">
                     <asp:TextBox ID="txtusername" type="text" runat="server" ReadOnly="true" class="form-control"   placeholder="User name"></asp:TextBox>
                ...
                <div class="form-group row">
                 ...
                 <div class="col-sm-10">
                <asp:TextBox ID="txtOldPassword" type="password" runat="server" class="form-control" placeholder="Old Password"></asp:TextBox>
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-10">
                <asp:TextBox ID="txtNewPassword" type="password" runat="server" class="form-control" placeholder="New Password"></asp:TextBox>
                ...
                <div class="form-group row">
                 ...
                 <div class="col-sm-10">
                <asp:TextBox ID="txtconfirm" type="password" runat="server" class="form-control" placeholder="confrim Password"></asp:TextBox>
                ...
                <div class="form-group row">
                 <div class="col-sm-10"">
                <asp:Button ID="btnChangePassword" type="submit" runat="server" class="btn btn-info btn-block" Text="Change Password" OnClientClick="return valid()" />
                 </div>
             </div>
